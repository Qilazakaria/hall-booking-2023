...
<html>
	...
	<body onload="onHide(); setURL()">
		...
		<div class="card w-50" style="margin: 10px auto">
		  	<h5 class="card-header"><b>UPDATE ASSET</b></h5>
		  	<div class="card-body">
				<form action="/UpdateAssetController" method="post">
					<label class="form-label">Asset Name : </label>
					<input class="form-control mb-2" type="text" id="assetsid" name="assetsid" value="<c:out value="${asset.assetsid}"/>" hidden="hidden">
