...
<html>
	...
	<body>
		...
		<div class="card w-50" style="margin: 10px auto">
			<h5 class="card-header"><b>UPDATE STAFF</b></h5>
			<div class="card-body">
				<form action="StaffUpdateFunction.jsp" method="post" id="wizard">
					<label class="form-label" for="staffname">Name <span class="text-danger fw-bold">*</span> : </label>
				    <input class="form-control mb-2" type="hidden"  name="staffid" id="staffid" value="<%=staff.getStaffid() %>" required>
				    <input class="form-control mb-2" type="text"  name="staffname" id="staffname" value="<%=staff.getStaffname() %>" required>
				    
				    <label class="form-label" for="staffemail">Email <span class="text-danger fw-bold">*</span> : </label>
				    <input class="form-control mb-2" type="email"  name="staffemail" id="staffemail" value="<%=staff.getStaffemail() %>" required>
				    
				    <label class="form-label" for="staffhomeno">Home No. <span class="text-danger fw-bold">*</span> : </label>
				    <input class="form-control mb-2" type="number"  name="staffhomeno" id="staffhomeno" value="<%=staff.getStaffhomeno() %>" required>
				    
				    <label class="form-label" for="staffaddress">Address <span class="text-danger fw-bold">*</span> : </label>
				    <input class="form-control mb-2" type="text" name="staffaddress" id="staffaddress" value="<%=staff.getStaffaddress() %>" required>
				    
				    <label class="form-label" for="staffcity">City <span class="text-danger fw-bold">*</span> : </label>
				    <input class="form-control mb-2" type="text"  name="staffcity" id="staffcity" value="<%=staff.getStaffcity() %>" required>
				    
				    <label class="form-label" for="staffposcode">PostCode <span class="text-danger fw-bold">*</span> : </label>
				    <input class="form-control mb-2" type="number"  name="staffposcode" id="staffposcode" value="<%=staff.getStaffposcode() %>" required>
