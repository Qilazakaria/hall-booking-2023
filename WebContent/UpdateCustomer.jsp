		...
		<div class="card w-50" style="margin: 10px auto">
			...
			<div class="card-body">
				<form action="/UpdateCustomerController" method="post" id="wizard">
				    ...
				    <input class="form-control mb-2" type="number" id="custidentificationcard" name="custidentificationcard" value="<c:out value="${customer.custidentificationcard}" />" required>
